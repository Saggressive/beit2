...
mask=$3
seed=$4
name=pair_cl_mim_alpha${alpha}_mask${mask}_seed${seed}
# all_dir=./save/condenser/${name}_${temp_v}_${a0}_${a1}_${a2}_${a3}_epoch50
all_dir=save/pair_cl_alphasearch_seed_epoch2/${name}
log_dir=save/pair_cl_alphasearch_seed_epoch2/tensorboard_log/${name}
mkdir -p ${all_dir}
mkdir -p ${log_dir}
