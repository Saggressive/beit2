...
LR=$3
seed=$4
name=noinit_all_LR${LR}_alpha${alpha}_seed${seed}
# all_dir=./save/condenser/${name}_${LR}_${a0}_${a1}_${a2}_${a3}_epoch50
all_dir=save/beit_condenser_batch64/no_init/${name}
log_dir=save/beit_condenser_batch64/no_init/tensorboard_log/${name}
mkdir -p ${all_dir}
mkdir -p ${log_dir}
