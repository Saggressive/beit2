...
def get_coco_caps(ann_dir, out_dir, image_dir):
    ...
    for id in img_ids:
        ...
        image = coco_caps.loadImgs([id])
        img_paths.append(os.path.join(image_dir,image[0]["file_name"]))
    ...
    # Save captions
    curr_paths_fname = osp.join(out_dir, 'coco_random_captions.json')
...
if __name__=="__main__":
    ...
    parser.add_argument('--ann_dir', type=str, default='ir_data/annotations')
    ...
    # get random captions
    img_ids = get_coco_caps(args.ann_dir, args.output_dir, args.image_dir)
