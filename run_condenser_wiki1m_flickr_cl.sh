...
LR=$3
seed=$4
name=wiki1m_flick_cl_LR${LR}_alpha${alpha}_seed${seed}
# all_dir=./save/condenser/${name}_${LR}_${a0}_${a1}_${a2}_${a3}_epoch50
all_dir=save/try_condenser_proc/${name}
log_dir=save/try_condenser_proc/tensorboard_log/${name}
mkdir -p ${all_dir}
mkdir -p ${log_dir}
nohup python run_mib_pretraining.py \
    ...
    --text_data_path ir_data/wiki1m_flickr_for_simcse.txt \
    --output_dir ${all_dir} \
    --log_dir ${log_dir} \
