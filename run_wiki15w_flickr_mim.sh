...
LR=$3
seed=$4
name=wiki15w_flickr_mim_LR${LR}_alpha${alpha}_seed${seed}
# all_dir=./save/condenser/${name}_${LR}_${a0}_${a1}_${a2}_${a3}_epoch50
all_dir=save/wiki15w_flickr_mim/${name}
log_dir=save/wiki15w_flickr_mim/tensorboard_log/${name}
mkdir -p ${all_dir}
mkdir -p ${log_dir}
nohup python run_mib_pretraining.py \
    ...
    --text_data_path ir_data/wiki15w.txt \
    --output_dir ${all_dir} \
    --log_dir ${log_dir} \
